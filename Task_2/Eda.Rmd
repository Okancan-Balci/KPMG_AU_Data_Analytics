...
Customer_Joined %>% 
  ggplot(aes(profit_per_transaction, reorder(diverging_job_title, profit_per_transaction, FUN = median), fill = diverging_job_title))+
  geom_boxplot(show.legend = F, alpha = 0.7)+
  geom_vline(aes(xintercept = median(profit_per_transaction)), color = "red", linewidth = 1.1, alpha = 0.8)+
  labs(x = NULL, y = NULL)+
  theme_minimal()
```
